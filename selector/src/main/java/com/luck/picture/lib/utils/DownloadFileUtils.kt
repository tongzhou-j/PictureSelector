...
object DownloadFileUtils {
    ...
    fun saveLocalFile(
        ...
        PictureThreadUtils.executeByIo<String?>(object : SimpleTask<String?>() {
            override fun doInBackground(): String? {
                try {
                    ...
                    if (PictureMimeType.isHasAudio(mimeType)) {
                        ...
                        if (SdkVersionUtils.isQ) {
                            ...
                            val dir = if (TextUtils.equals(
                                ...
                                File(FileDirMap.getFileDirPath(context, SelectMimeType.TYPE_AUDIO) ?: return null)
                            contentValues.put(
                        ...
                        if (SdkVersionUtils.isQ) {
                            ...
                            val dir = if (TextUtils.equals(
                                ...
                                File(FileDirMap.getFileDirPath(context, SelectMimeType.TYPE_VIDEO) ?: return null)
                            contentValues.put(
                                MediaStore.MediaColumns.DATA,
                                (dir.absolutePath + File.separator
                    ...
                    if (uri != null) {
                        ...
                        val outputStream = PictureContentResolver.openOutputStream(context, uri)
                        if (outputStream != null && PictureFileUtils.writeFileFromIS(inputStream, outputStream)) {
