...
class PictureSelectionCameraModel(private val selector: PictureSelector, chooseMode: Int) {
     ...
     */
    fun isNewKeyBackMode(isNewKeyBackMode: Boolean): PictureSelectionCameraModel {
     ...
     * @return
     */
    fun setSelectedData(selectedList: MutableList<LocalMedia?>?): PictureSelectionCameraModel {
            ...
            if (activity !is IBridgePictureBehavior) {
                throw NullPointerException(
                    "Use only camera openCamera mode," +
                            "Activity or Fragment interface needs to be implemented " + IBridgePictureBehavior::class.java.canonicalName
                )
            }
    ...
    fun build(): PictureOnlyCameraFragment {
        ...
        return PictureOnlyCameraFragment.newInstance()
    }
    ...
    fun buildLaunch(
        ...
        val onlyCameraFragment = PictureOnlyCameraFragment.newInstance()
