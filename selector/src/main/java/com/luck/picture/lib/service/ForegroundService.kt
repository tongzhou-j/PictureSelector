...
class ForegroundService : Service() {
    ...
    private fun createForegroundNotification(): Notification {
        ...
        val config: SelectorConfig = SelectorProviders.instance?.selectorConfig ?: SelectorConfig()
        val contentText = if (config.chooseMode == SelectMimeType.ofAudio())
            getString(R.string.ps_use_sound)
        else
            getString(R.string.ps_use_camera)
    ...
    companion object {
        ...
        private val CHANNEL_NAME = BuildConfig.LIBRARY_PACKAGE_NAME
