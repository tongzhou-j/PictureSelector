...
object LightStatusBarUtils {
    ...
    fun setLightStatusBar(
        ...
        when (RomUtils.lightStatusBarAvailableRomType) {
            RomUtils.AvailableRomType.MIUI -> if (RomUtils.mIUIVersionCode >= 7) {
                LightStatusBarUtils.setAndroidNativeLightStatusBar(
                    activity,
                    isMarginStatusBar,
                    isMarginNavigationBar,
                    isTransStatusBar,
                ...
                LightStatusBarUtils.setMIUILightStatusBar(
                    activity,
                    isMarginStatusBar,
                    isMarginNavigationBar,
                    isTransStatusBar,
            ...
            RomUtils.AvailableRomType.FLYME -> LightStatusBarUtils.setFlymeLightStatusBar(
                activity,
                isMarginStatusBar,
                isMarginNavigationBar,
                isTransStatusBar,
            ...
            RomUtils.AvailableRomType.ANDROID_NATIVE -> LightStatusBarUtils.setAndroidNativeLightStatusBar(
                activity,
                isMarginStatusBar,
                isMarginNavigationBar,
                isTransStatusBar,
    ...
    private fun setMIUILightStatusBar(
        activity: Activity, isMarginStatusBar: Boolean,
        isMarginNavigationBar: Boolean, isTransStatusBar: Boolean, darkmode: Boolean
    ): Boolean {
    ...
    private fun setFlymeLightStatusBar(
        ...
        var result = false
        if (activity != null) {
            LightStatusBarUtils.initStatusBarStyle(
                activity,
                isMarginStatusBar,
                isMarginNavigationBar
            )
