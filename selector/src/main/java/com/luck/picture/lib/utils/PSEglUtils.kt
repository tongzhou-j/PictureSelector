...
object PSEglUtils {
        ...
        get() {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                    return PSEglUtils.maxTextureEgl14
                } else {
                    return PSEglUtils.maxTextureEgl10
                }
            } catch (e: Exception) {
                Log.d(PSEglUtils.TAG, "getMaxTextureSize: ", e)
                return 0
            }
        }
    ...
    private val maxTextureEgl14: Int
        get() {
            ...
            val surf =
                EGL14.eglCreatePbufferSurface(dpy, config, surfAttr, 0)
    ...
    private val maxTextureEgl10: Int
        get() {
            ...
            val configs =
                arrayOfNulls<javax.microedition.khronos.egl.EGLConfig>(1)
            val numConfig = IntArray(1)
