 ...
 */
class LineWrapRadioGroup @JvmOverloads constructor(
    context: Context,
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until count) {
            ...
            if (lineWidth + deltaX + paddingLeft + paddingRight > widthSize) { //如果折行,height增加
                ...
                maxWidth = maxWidth.coerceAtLeast(lineWidth).coerceAtLeast(oldWidth)
                //重置宽度
                lineWidth = deltaX
                //累加高度
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        for (i in 0 until count) {
            ...
            if (preLeft + params.leftMargin + child.measuredWidth + params.rightMargin + paddingRight > r - l) {
                ...
                maxHeight = maxHeight.coerceAtLeast(child.measuredHeight + params.topMargin + params.bottomMargin)
            }
            //left坐标
