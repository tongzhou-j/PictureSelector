...
object LightStatusBarUtils {
    @JvmStatic
    fun setLightStatusBarAboveAPI23(activity: Activity, isMarginStatusBar: Boolean,
    ...
    @JvmStatic
    fun setLightStatusBar(activity: Activity, isMarginStatusBar: Boolean,
                          isMarginNavigationBar: Boolean, isTransStatusBar: Boolean, dark: Boolean) {
        when (RomUtils.getLightStatausBarAvailableRomType()) {
            ...
            RomUtils.AvailableRomType.ANDROID_NATIVE -> {
                setAndroidNativeLightStatusBar(activity, isMarginStatusBar, isMarginNavigationBar, isTransStatusBar, dark)
            }
    ...
    private fun setMIUILightStatusBar(activity: Activity, isMarginStatusBar: Boolean,
                                      isMarginNavigationBar: Boolean, isTransStatusBar: Boolean, darkmode: Boolean): Boolean {
    ...
    private fun setFlymeLightStatusBar(activity: Activity, isMarginStatusBar: Boolean,
                                       isMarginNavigationBar: Boolean, isTransStatusBar: Boolean, dark: Boolean): Boolean {
        var result = false
        if (activity != null) {
            initStatusBarStyle(activity, isMarginStatusBar, isMarginNavigationBar)
            try {
    ...
    @TargetApi(11)
    private fun setAndroidNativeLightStatusBar(activity: Activity, isMarginStatusBar: Boolean,
                                                isMarginNavigationBar: Boolean, isTransStatusBar: Boolean, isDarkStatusBarIcon: Boolean) {
        try {
            if (isTransStatusBar) {
                val window = activity.window
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    when {
                        isMarginStatusBar && isMarginNavigationBar -> {
                            //5.0版本及以上
    ...
    private fun initStatusBarStyle(activity: Activity, isMarginStatusBar: Boolean,
